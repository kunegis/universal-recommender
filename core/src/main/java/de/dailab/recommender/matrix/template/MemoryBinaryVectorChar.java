...
/**
 * A sparse binary memory-held vector with fast indexing, indexed by char, and iterable in index order.
 * <p>
...
final class MemoryBinaryVectorChar
	implements Vector
{
	/**
	 * A memory vector with initial capacity of zero.
	 */
	public MemoryBinaryVectorChar()
	{}
	 ...
	 */
	public MemoryBinaryVectorChar(int capacity)
	{
