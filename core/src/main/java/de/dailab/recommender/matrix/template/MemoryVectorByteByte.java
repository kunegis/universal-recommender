...
/**
 * A sparse memory-held vector of bytes with fast indexing, indexed by byte.
 * <p>
...
final class MemoryVectorByteByte
	implements Vector
{
	/**
	 * A memory vector with initial capacity of zero.
	 */
	public MemoryVectorByteByte()
	{}
	 ...
	 */
	public MemoryVectorByteByte(int capacity)
	{
	 ...
	 */
	public void add(byte i, byte value)
	{
		assert indexes == null && values == null || indexes.length == values.length;
		assert capacity >= 0;
		assert indexes == null && values == null && capacity == 0 || capacity <= indexes.length;
