...
/**
 * A sparse memory-held vector of doubles with fast indexing, indexed by byte.
 * <p>
...
final class MemoryVectorByteDouble
	implements Vector
{
	/**
	 * A memory vector with initial capacity of zero.
	 */
	public MemoryVectorByteDouble()
	{}
	 ...
	 */
	public MemoryVectorByteDouble(int capacity)
	{
	 ...
	 */
	public void set(byte i, double value)
	{
	 ...
	 */
	public void add(byte i, double value)
	{
		assert indexes == null && values == null || indexes.length == values.length;
		assert capacity >= 0;
		assert indexes == null && values == null && capacity == 0 || capacity <= indexes.length;
