...
/**
 * A sparse memory-held vector of floats with fast indexing, indexed by byte.
 * <p>
...
final class MemoryVectorByteFloat
	implements Vector
{
	/**
	 * A memory vector with initial capacity of zero.
	 */
	public MemoryVectorByteFloat()
	{}
	 ...
	 */
	public MemoryVectorByteFloat(int capacity)
	{
	 ...
	 */
	public void set(byte i, float value)
	{
	 ...
	 */
	public void add(byte i, float value)
	{
		assert indexes == null && values == null || indexes.length == values.length;
		assert capacity >= 0;
		assert indexes == null && values == null && capacity == 0 || capacity <= indexes.length;
