...
/**
 * A sparse memory-held vector of ints with fast indexing, indexed by byte.
 * <p>
...
final class MemoryVectorByteInt
	implements Vector
{
	/**
	 * A memory vector with initial capacity of zero.
	 */
	public MemoryVectorByteInt()
	{}
	 ...
	 */
	public MemoryVectorByteInt(int capacity)
	{
	 ...
	 */
	public void set(byte i, int value)
	{
	 ...
	 */
	public void add(byte i, int value)
	{
		assert indexes == null && values == null || indexes.length == values.length;
		assert capacity >= 0;
		assert indexes == null && values == null && capacity == 0 || capacity <= indexes.length;
