...
/**
 * A sparse memory-held vector of longs with fast indexing, indexed by byte.
 * <p>
...
final class MemoryVectorByteLong
	implements Vector
{
	/**
	 * A memory vector with initial capacity of zero.
	 */
	public MemoryVectorByteLong()
	{}
	 ...
	 */
	public MemoryVectorByteLong(int capacity)
	{
	 ...
	 */
	public void add(byte i, long value)
	{
		assert indexes == null && values == null || indexes.length == values.length;
		assert capacity >= 0;
		assert indexes == null && values == null && capacity == 0 || capacity <= indexes.length;
