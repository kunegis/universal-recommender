...
/**
 * A sparse memory-held vector of shorts with fast indexing, indexed by byte.
 * <p>
...
final class MemoryVectorByteShort
	implements Vector
{
	/**
	 * A memory vector with initial capacity of zero.
	 */
	public MemoryVectorByteShort()
	{}
	 ...
	 */
	public MemoryVectorByteShort(int capacity)
	{
	 ...
	 */
	public void set(byte i, short value)
	{
	 ...
	 */
	public void add(byte i, short value)
	{
		assert indexes == null && values == null || indexes.length == values.length;
		assert capacity >= 0;
		assert indexes == null && values == null && capacity == 0 || capacity <= indexes.length;
