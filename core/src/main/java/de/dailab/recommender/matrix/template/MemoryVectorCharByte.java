...
/**
 * A sparse memory-held vector of bytes with fast indexing, indexed by char.
 * <p>
...
final class MemoryVectorCharByte
	implements Vector
{
	/**
	 * A memory vector with initial capacity of zero.
	 */
	public MemoryVectorCharByte()
	{}
	 ...
	 */
	public MemoryVectorCharByte(int capacity)
	{
	 ...
	 */
	public void set(char i, byte value)
	{
		...
		if (indexes == null || indexes.length < newCapacity)
		{
			...
			final byte newValues[] = new byte[allocatedCapacity];
			if (indexes != null)
			{
	 ...
	 */
	public void add(char i, byte value)
	{
		assert indexes == null && values == null || indexes.length == values.length;
		assert capacity >= 0;
		assert indexes == null && values == null && capacity == 0 || capacity <= indexes.length;
