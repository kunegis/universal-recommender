...
/**
 * A sparse memory-held vector of chars with fast indexing, indexed by char.
 * <p>
...
final class MemoryVectorCharChar
	implements Vector
{
	/**
	 * A memory vector with initial capacity of zero.
	 */
	public MemoryVectorCharChar()
	{}
	 ...
	 */
	public MemoryVectorCharChar(int capacity)
	{
	 ...
	 */
	public void set(char i, char value)
	{
	 ...
	 */
	public void add(char i, char value)
	{
		assert indexes == null && values == null || indexes.length == values.length;
		assert capacity >= 0;
		assert indexes == null && values == null && capacity == 0 || capacity <= indexes.length;
