...
/**
 * A sparse memory-held vector of doubles with fast indexing, indexed by char.
 * <p>
...
final class MemoryVectorCharDouble
	implements Vector
{
	/**
	 * A memory vector with initial capacity of zero.
	 */
	public MemoryVectorCharDouble()
	{}
	 ...
	 */
	public MemoryVectorCharDouble(int capacity)
	{
	 ...
	 */
	public void set(char i, double value)
	{
	 ...
	 */
	public void add(char i, double value)
	{
		assert indexes == null && values == null || indexes.length == values.length;
		assert capacity >= 0;
		assert indexes == null && values == null && capacity == 0 || capacity <= indexes.length;
