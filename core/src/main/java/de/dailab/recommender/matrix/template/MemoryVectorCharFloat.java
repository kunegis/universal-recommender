...
/**
 * A sparse memory-held vector of floats with fast indexing, indexed by char.
 * <p>
...
final class MemoryVectorCharFloat
	implements Vector
{
	/**
	 * A memory vector with initial capacity of zero.
	 */
	public MemoryVectorCharFloat()
	{}
	 ...
	 */
	public MemoryVectorCharFloat(int capacity)
	{
	 ...
	 */
	public void set(char i, float value)
	{
		...
		if (indexes == null || indexes.length < newCapacity)
		{
			...
			final float newValues[] = new float[allocatedCapacity];
			if (indexes != null)
			{
	 ...
	 */
	public void add(char i, float value)
	{
		assert indexes == null && values == null || indexes.length == values.length;
		assert capacity >= 0;
		assert indexes == null && values == null && capacity == 0 || capacity <= indexes.length;
