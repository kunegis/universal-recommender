...
/**
 * A sparse memory-held vector of ints with fast indexing, indexed by char.
 * <p>
...
final class MemoryVectorCharInt
	implements Vector
{
	/**
	 * A memory vector with initial capacity of zero.
	 */
	public MemoryVectorCharInt()
	{}
	 ...
	 */
	public MemoryVectorCharInt(int capacity)
	{
	...
	public void set(char i, int value)
	{
		...
		if (indexes == null || indexes.length < newCapacity)
		{
			...
			final int newValues[] = new int[allocatedCapacity];
			if (indexes != null)
			{
	 ...
	 */
	public void add(char i, int value)
	{
		assert indexes == null && values == null || indexes.length == values.length;
		assert capacity >= 0;
		assert indexes == null && values == null && capacity == 0 || capacity <= indexes.length;
