...
/**
 * A sparse memory-held vector of longs with fast indexing, indexed by char.
 * <p>
...
final class MemoryVectorCharLong
	implements Vector
{
	/**
	 * A memory vector with initial capacity of zero.
	 */
	public MemoryVectorCharLong()
	{}
	 ...
	 */
	public MemoryVectorCharLong(int capacity)
	{
	 ...
	 */
	public void set(char i, long value)
	{
		...
		if (indexes == null || indexes.length < newCapacity)
		{
			...
			final long newValues[] = new long[allocatedCapacity];
			if (indexes != null)
			{
	 ...
	 */
	public void add(char i, long value)
	{
		assert indexes == null && values == null || indexes.length == values.length;
		assert capacity >= 0;
		assert indexes == null && values == null && capacity == 0 || capacity <= indexes.length;
