...
/**
 * A sparse memory-held vector of shorts with fast indexing, indexed by char.
 * <p>
 * Size and orientation are not stored.
 * <p>
 * Indexes can be negative generally (if allowed by type char). 
 * 
 * @author autogenerated
 */
@SuppressWarnings("all")
final class MemoryVectorCharShort
	implements Vector
{
	/**
	 * A memory vector with initial capacity of zero.
	 */
	public MemoryVectorCharShort()
	{}
	 ...
	 */
	public MemoryVectorCharShort(int capacity)
	{
		indexes = new char[capacity];
	 ...
	 */
	public void set(char i, short value)
	{
		...
		if (indexes == null || indexes.length < newCapacity)
		{
			...
			final char newIndexes[] = new char[allocatedCapacity];
			final short newValues[] = new short[allocatedCapacity];
			if (indexes != null)
			{
	 ...
	 */
	public void add(char i, short value)
	{
		assert indexes == null && values == null || indexes.length == values.length;
		assert capacity >= 0;
		assert indexes == null && values == null && capacity == 0 || capacity <= indexes.length;
