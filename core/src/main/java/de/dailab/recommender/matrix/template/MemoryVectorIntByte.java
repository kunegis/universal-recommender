...
/**
 * A sparse memory-held vector of bytes with fast indexing, indexed by int.
 * <p>
...
final class MemoryVectorIntByte
	implements Vector
{
	/**
	 * A memory vector with initial capacity of zero.
	 */
	public MemoryVectorIntByte()
	{}
	 ...
	 */
	public MemoryVectorIntByte(int capacity)
	{
