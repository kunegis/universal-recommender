...
/**
 * A sparse memory-held vector of chars with fast indexing, indexed by int.
 * <p>
...
final class MemoryVectorIntChar
	implements Vector
{
	/**
	 * A memory vector with initial capacity of zero.
	 */
	public MemoryVectorIntChar()
	{}
	 ...
	 */
	public MemoryVectorIntChar(int capacity)
	{
	 ...
	 */
	public void add(int i, char value)
	{
		assert indexes == null && values == null || indexes.length == values.length;
		assert capacity >= 0;
		assert indexes == null && values == null && capacity == 0 || capacity <= indexes.length;
