...
/**
 * A sparse memory-held vector of floats with fast indexing, indexed by int.
 * <p>
...
final class MemoryVectorIntFloat
	implements Vector
{
	/**
	 * A memory vector with initial capacity of zero.
	 */
	public MemoryVectorIntFloat()
	{}
	 ...
	 */
	public MemoryVectorIntFloat(int capacity)
	{
