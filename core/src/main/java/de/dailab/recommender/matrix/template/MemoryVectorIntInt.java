...
/**
 * A sparse memory-held vector of ints with fast indexing, indexed by int.
 * <p>
...
final class MemoryVectorIntInt
	implements Vector
{
	/**
	 * A memory vector with initial capacity of zero.
	 */
	public MemoryVectorIntInt()
	{}
	 ...
	 */
	public MemoryVectorIntInt(int capacity)
	{
