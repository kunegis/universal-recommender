...
/**
 * A sparse memory-held vector of longs with fast indexing, indexed by int.
 * <p>
...
final class MemoryVectorIntLong
	implements Vector
{
	/**
	 * A memory vector with initial capacity of zero.
	 */
	public MemoryVectorIntLong()
	{}
	 ...
	 */
	public MemoryVectorIntLong(int capacity)
	{
