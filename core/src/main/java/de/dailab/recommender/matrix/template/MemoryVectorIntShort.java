...
/**
 * A sparse memory-held vector of shorts with fast indexing, indexed by int.
 * <p>
...
final class MemoryVectorIntShort
	implements Vector
{
	/**
	 * A memory vector with initial capacity of zero.
	 */
	public MemoryVectorIntShort()
	{}
	 ...
	 */
	public MemoryVectorIntShort(int capacity)
	{
	 ...
	 */
	public void add(int i, short value)
	{
		assert indexes == null && values == null || indexes.length == values.length;
		assert capacity >= 0;
		assert indexes == null && values == null && capacity == 0 || capacity <= indexes.length;
