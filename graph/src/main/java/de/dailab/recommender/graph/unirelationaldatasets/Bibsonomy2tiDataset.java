...
/**
 * Access to the unirelational bibsonomy-2ti dataset in the Graph Store.
 * 
 * @author autogenerated
 */
@SuppressWarnings("all")
public class Bibsonomy2tiDataset
      extends UnirelationalGraphStoreDataset
{
	/**
	 * Load the unirelational bibsonomy-2ti dataset from the Graph Store.
	 * 
	 * @throws IOException on IO errors
	 * @throws TextSyntaxException syntax error in the text file
	 */
	public Bibsonomy2tiDataset()
	 ...
	 */
	public final static String NAME = "bibsonomy-2ti"; 
}	
