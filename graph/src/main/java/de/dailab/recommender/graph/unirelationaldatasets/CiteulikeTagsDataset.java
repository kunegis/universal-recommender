...
/**
 * Access to the unirelational citeulike-tags dataset in the Graph Store.
 * 
 * @author autogenerated
 */
@SuppressWarnings("all")
public class CiteulikeTagsDataset
      extends UnirelationalGraphStoreDataset
{
	/**
	 * Load the unirelational citeulike-tags dataset from the Graph Store.
	 * 
	 * @throws IOException on IO errors
	 * @throws TextSyntaxException syntax error in the text file
	 */
	public CiteulikeTagsDataset()
	        throws IOException, TextSyntaxException
	{
		super("citeulike-tags");		
	}

	/**
	 * The name of the underlying dataset.  
	 */
	public final static String NAME = "citeulike-tags"; 
}	
