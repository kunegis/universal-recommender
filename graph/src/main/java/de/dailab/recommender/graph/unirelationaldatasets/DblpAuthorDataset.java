...
/**
 * Access to the unirelational dblp-author dataset in the Graph Store.
 * 
 * @author autogenerated
 */
@SuppressWarnings("all")
public class DblpAuthorDataset
      extends UnirelationalGraphStoreDataset
{
	/**
	 * Load the unirelational dblp-author dataset from the Graph Store.
	 * 
	 * @throws IOException on IO errors
	 * @throws TextSyntaxException syntax error in the text file
	 */
	public DblpAuthorDataset()
	 ...
	 */
	public final static String NAME = "dblp-author"; 
}	
