...
/**
 * Access to the unirelational dblp-cite dataset in the Graph Store.
 * 
 * @author autogenerated
 */
@SuppressWarnings("all")
public class DblpCiteDataset
      extends UnirelationalGraphStoreDataset
{
	/**
	 * Load the unirelational dblp-cite dataset from the Graph Store.
	 * 
	 * @throws IOException on IO errors
	 * @throws TextSyntaxException syntax error in the text file
	 */
	public DblpCiteDataset()
	 ...
	 */
	public final static String NAME = "dblp-cite"; 
}	
