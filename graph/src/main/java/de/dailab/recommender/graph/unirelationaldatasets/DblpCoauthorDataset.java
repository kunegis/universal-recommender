...
/**
 * Access to the unirelational dblp_coauthor dataset in the Graph Store.
 * 
 * @author autogenerated
 */
@SuppressWarnings("all")
public class DblpCoauthorDataset
      extends UnirelationalGraphStoreDataset
{
	/**
	 * Load the unirelational dblp_coauthor dataset from the Graph Store.
	 * 
	 * @throws IOException on IO errors
	 * @throws TextSyntaxException syntax error in the text file
	 */
	public DblpCoauthorDataset()
	 ...
	 */
	public final static String NAME = "dblp_coauthor"; 
}	
