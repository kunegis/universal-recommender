...
/**
 * Access to the unirelational delicious-it dataset in the Graph Store.
 * 
 * @author autogenerated
 */
@SuppressWarnings("all")
public class DeliciousItDataset
      extends UnirelationalGraphStoreDataset
{
	/**
	 * Load the unirelational delicious-it dataset from the Graph Store.
	 * 
	 * @throws IOException on IO errors
	 * @throws TextSyntaxException syntax error in the text file
	 */
	public DeliciousItDataset()
	 ...
	 */
	public final static String NAME = "delicious-it"; 
}	
