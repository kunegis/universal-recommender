...
/**
 * Access to the unirelational delicious-ui dataset in the Graph Store.
 * 
 * @author autogenerated
 */
@SuppressWarnings("all")
public class DeliciousUiDataset
      extends UnirelationalGraphStoreDataset
{
	/**
	 * Load the unirelational delicious-ui dataset from the Graph Store.
	 * 
	 * @throws IOException on IO errors
	 * @throws TextSyntaxException syntax error in the text file
	 */
	public DeliciousUiDataset()
	 ...
	 */
	public final static String NAME = "delicious-ui"; 
}	
