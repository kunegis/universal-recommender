...
/**
 * Access to the unirelational filmtipset dataset in the Graph Store.
 * 
 * @author autogenerated
 */
@SuppressWarnings("all")
public class FilmtipsetDataset
      extends UnirelationalGraphStoreDataset
{
	/**
	 * Load the unirelational filmtipset dataset from the Graph Store.
	 * 
	 * @throws IOException on IO errors
	 * @throws TextSyntaxException syntax error in the text file
	 */
	public FilmtipsetDataset()
	 ...
	 */
	public final static String NAME = "filmtipset"; 
}	
