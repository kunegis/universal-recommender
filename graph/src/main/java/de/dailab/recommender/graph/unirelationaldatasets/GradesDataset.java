...
/**
 * Access to the unirelational grades dataset in the Graph Store.
 * 
...
{
	/**
	 * Load the unirelational grades dataset from the Graph Store.
	 * 
	 * @throws IOException on IO errors
	 * @throws TextSyntaxException syntax error in the text file
	 */
	public GradesDataset()
	 ...
	 */
	public final static String NAME = "grades"; 
}	
