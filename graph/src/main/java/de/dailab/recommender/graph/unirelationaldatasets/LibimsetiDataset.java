...
/**
 * Access to the unirelational libimseti dataset in the Graph Store.
 * 
 * @author autogenerated
 */
@SuppressWarnings("all")
public class LibimsetiDataset
      extends UnirelationalGraphStoreDataset
{
	/**
	 * Load the unirelational libimseti dataset from the Graph Store.
	 * 
	 * @throws IOException on IO errors
	 * @throws TextSyntaxException syntax error in the text file
	 */
	public LibimsetiDataset()
	 ...
	 */
	public final static String NAME = "libimseti"; 
}	
