...
/**
 * Access to the unirelational movielens-100k_rating dataset in the Graph Store.
 * 
 * @author autogenerated
 */
@SuppressWarnings("all")
public class Movielens100kRatingDataset
      extends UnirelationalGraphStoreDataset
{
	/**
	 * Load the unirelational movielens-100k_rating dataset from the Graph Store.
	 * 
	 * @throws IOException on IO errors
	 * @throws TextSyntaxException syntax error in the text file
	 */
	public Movielens100kRatingDataset()
	        throws IOException, TextSyntaxException
	{
		super("movielens-100k_rating");		
	}

	/**
	 * The name of the underlying dataset.  
	 */
	public final static String NAME = "movielens-100k_rating"; 
