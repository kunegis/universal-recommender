...
/**
 * Access to the unirelational slashdot-zoo dataset in the Graph Store.
 * 
 * @author autogenerated
 */
@SuppressWarnings("all")
public class SlashdotZooDataset
      extends UnirelationalGraphStoreDataset
{
	/**
	 * Load the unirelational slashdot-zoo dataset from the Graph Store.
	 * 
	 * @throws IOException on IO errors
	 * @throws TextSyntaxException syntax error in the text file
	 */
	public SlashdotZooDataset()
	 ...
	 */
	public final static String NAME = "slashdot-zoo"; 
}	
