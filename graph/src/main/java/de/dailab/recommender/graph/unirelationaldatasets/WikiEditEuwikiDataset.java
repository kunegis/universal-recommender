...
/**
 * Access to the unirelational wiki-edit-euwiki dataset in the Graph Store.
 * 
 * @author autogenerated
 */
@SuppressWarnings("all")
public class WikiEditEuwikiDataset
      extends UnirelationalGraphStoreDataset
{
	/**
	 * Load the unirelational wiki-edit-euwiki dataset from the Graph Store.
	 * 
	 * @throws IOException on IO errors
	 * @throws TextSyntaxException syntax error in the text file
	 */
	public WikiEditEuwikiDataset()
	        throws IOException, TextSyntaxException
	{
		super("wiki-edit-euwiki");		
	}

	/**
	 * The name of the underlying dataset.  
	 */
	public final static String NAME = "wiki-edit-euwiki"; 
}	
