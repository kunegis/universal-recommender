...
/**
 * Access to the unirelational wiki-edit-frwikibooks dataset in the Graph Store.
 * 
 * @author autogenerated
 */
@SuppressWarnings("all")
public class WikiEditFrwikibooksDataset
      extends UnirelationalGraphStoreDataset
{
	/**
	 * Load the unirelational wiki-edit-frwikibooks dataset from the Graph Store.
	 * 
	 * @throws IOException on IO errors
	 * @throws TextSyntaxException syntax error in the text file
	 */
	public WikiEditFrwikibooksDataset()
	        throws IOException, TextSyntaxException
	{
		super("wiki-edit-frwikibooks");		
	}

	/**
	 * The name of the underlying dataset.  
	 */
	public final static String NAME = "wiki-edit-frwikibooks"; 
}	
