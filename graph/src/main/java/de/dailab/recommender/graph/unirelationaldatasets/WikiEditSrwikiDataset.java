...
/**
 * Access to the unirelational wiki-edit-srwiki dataset in the Graph Store.
 * 
 * @author autogenerated
 */
@SuppressWarnings("all")
public class WikiEditSrwikiDataset
      extends UnirelationalGraphStoreDataset
{
	/**
	 * Load the unirelational wiki-edit-srwiki dataset from the Graph Store.
	 * 
	 * @throws IOException on IO errors
	 * @throws TextSyntaxException syntax error in the text file
	 */
	public WikiEditSrwikiDataset()
	        throws IOException, TextSyntaxException
	{
		super("wiki-edit-srwiki");		
	}

	/**
	 * The name of the underlying dataset.  
	 */
	public final static String NAME = "wiki-edit-srwiki"; 
}	
