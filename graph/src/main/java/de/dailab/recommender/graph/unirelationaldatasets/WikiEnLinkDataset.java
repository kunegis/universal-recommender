...
/**
 * Access to the unirelational wiki-en-link dataset in the Graph Store.
 * 
 * @author autogenerated
 */
@SuppressWarnings("all")
public class WikiEnLinkDataset
      extends UnirelationalGraphStoreDataset
{
	/**
	 * Load the unirelational wiki-en-link dataset from the Graph Store.
	 * 
	 * @throws IOException on IO errors
	 * @throws TextSyntaxException syntax error in the text file
	 */
	public WikiEnLinkDataset()
	 ...
	 */
	public final static String NAME = "wiki-en-link"; 
}	
