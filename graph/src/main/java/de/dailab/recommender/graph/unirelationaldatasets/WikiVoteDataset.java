...
/**
 * Access to the unirelational wiki-Vote dataset in the Graph Store.
 * 
 * @author autogenerated
 */
@SuppressWarnings("all")
public class WikiVoteDataset
      extends UnirelationalGraphStoreDataset
{
	/**
	 * Load the unirelational wiki-Vote dataset from the Graph Store.
	 * 
	 * @throws IOException on IO errors
	 * @throws TextSyntaxException syntax error in the text file
	 */
	public WikiVoteDataset()
	 ...
	 */
	public final static String NAME = "wiki-Vote"; 
}	
