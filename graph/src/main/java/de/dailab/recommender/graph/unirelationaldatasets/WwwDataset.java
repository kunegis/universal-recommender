...
/**
 * Access to the unirelational www dataset in the Graph Store.
 * 
 * @author autogenerated
 */
@SuppressWarnings("all")
public class WwwDataset
      extends UnirelationalGraphStoreDataset
{
	/**
	 * Load the unirelational www dataset from the Graph Store.
	 * 
	 ...
	 */
	public final static String NAME = "www"; 
}	
