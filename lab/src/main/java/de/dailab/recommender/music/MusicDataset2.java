    ...
    extends SemanticStoreDataset
{
	 ...
	 * The location (country) entity type.
	 */
	public static final EntityType TRACK = new EntityType("track");

	/**
	 * The location (country) entity type.
	 */
	public static final EntityType ALBUM = new EntityType("album");
	    ...
	    throws SparqlException
	{
		    ...
		    { new SemanticMetadata(METADATA_FOAFNAME, new RdfName("rdfs:label")) }), }, new SemanticRelationshipType[]
		{
		    ...
		    new SemanticRelationshipType(ARTIST_LOC, new RdfName("pi:relates_to_location"), ARTIST, LOCATION,
		    ...
		    new SemanticRelationshipType(IN_LOC, new RdfName("location:inLocation"), LOCATION, COUNTRY,
		        RelationshipFormat.BIP, WeightRange.UNWEIGHTED),
		    new SemanticRelationshipType(ARTIST_TAG, new RdfName("pi:has_tag"), ARTIST, TAG, RelationshipFormat.BIP,
